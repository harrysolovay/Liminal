...
export const Suggestion = T.object({
  ...
  startLine: T.number`"The line on which the potentially-to-be-replaced span starts.`,
  endLine: T.number`The line on which the potentially-to-be-replaced span ends.`,
